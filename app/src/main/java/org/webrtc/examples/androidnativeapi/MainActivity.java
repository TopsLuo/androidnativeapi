...
public class MainActivity extends Activity {
  ...
  protected void onStart() {
    ...
    eglBase = EglBase.create(null /* sharedContext */, EglBase.CONFIG_PIXEL_BUFFER);
    ...
    localRenderer.init(eglBase.getEglBaseContext(), null /* rendererEvents */, EglBase.CONFIG_PIXEL_BUFFER,
        new GlRectDrawer());
    remoteRenderer.init(eglBase.getEglBaseContext(), null /* rendererEvents */,
        EglBase.CONFIG_PIXEL_BUFFER, new GlRectDrawer());
